...
# `render_template` a secas: el PR #43 saco las plantillas a archivos, asi que la
# variante que renderiza desde una cadena se quedo sin un solo uso.
# El resto son del endurecimiento del PR #44 y siguen usandose todos.
...
def api_ventas_dashboard():
    """Metricas de ventas por mes. La logica vive en `metricas_ventas`."""
    return jsonify(mv.resumen_dashboard(get_data('ventas')))
