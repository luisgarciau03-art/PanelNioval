...
|---|---|---|---|
| **#42** | **Plan 1** — relevancia de ciudades a nivel nacional. 606 municipios con datos DENUE 05_2026 + Censo 2020, modelo exógeno con ADR, 882 líneas de test nuevas | **OPEN · MERGEABLE · CI en verde** | desde 2026-08-29 |
